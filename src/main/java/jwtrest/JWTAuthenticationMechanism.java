...
//    @Inject private LoginBean loginBean;
    ...
    public AuthenticationStatus validateRequest(HttpServletRequest request, HttpServletResponse response, HttpMessageContext context) {
        ...
        try {
            if ((request.getSession().getAttribute("logged-group") == null) && (request.getRequestURI().contains("/admin_side/") || request.getRequestURI().contains("/user_side/"))) {
                ...
                if ((request.getRequestURI().contains("/admin_side/") && !request.getSession().getAttribute("logged-group").equals("admin"))) {
